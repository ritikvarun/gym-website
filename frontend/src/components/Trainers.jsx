  ...
  const fallbackCoaches = [
    {
      ...
      socials: { instagram: 'https://instagram.com/viktor_vance', twitter: '#' },
      certs: [
    ...
    },
    {
      ...
      socials: { instagram: 'https://instagram.com/seraphina_fit', twitter: '#' },
      certs: [
    ...
    },
    {
      ...
      socials: { instagram: 'https://instagram.com/marcus_drake', twitter: '#' },
      certs: [
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          {coaches.map((coach, idx) => {
            const rawInsta = coach.socials?.instagram || coach.instagram
            const hasInsta = rawInsta && rawInsta !== '#' && rawInsta.trim() !== ''
            const instaUrl = hasInsta 
            ...
            return (
              ...
              >
                ...
                {/* Small Elegant Instagram Icon (Bottom Right, Only if Insta ID exists) */}
                {hasInsta && (
                  <a
                    href={instaUrl}
                    target="_blank"
                    rel="noreferrer"
                    className="absolute bottom-6 right-6 z-30 p-2.5 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white shadow-xl shadow-black/60 hover:scale-115 transition-all duration-300 flex items-center justify-center cursor-pointer"
                    title={`Visit ${coach.name}'s Instagram`}
